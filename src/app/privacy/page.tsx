...
export const metadata: Metadata = pageMetadata({
  title: "ISSP Builder Privacy — Local-First, No Server Storage",
  description:
    "How ISSP Builder keeps agency data in the browser with local-first IndexedDB storage, no account requirement, and stateless PDF export.",
  path: "/privacy",
});
...
export default async function PrivacyPage() {
  const { title, author, date, html, readingTime } = await getPrivacyContent();
      ...
      <article className="max-w-[680px] mx-auto px-6">
        ...
        <div className="mt-14 pt-8 border-t border-gray-100 flex items-center justify-between flex-wrap gap-4">
          ...
          <Link
            ...
            style={{ background: "#0038A8" }}
          >
            About this project <ArrowRight className="w-3.5 h-3.5" />
          </Link>
        </div>
